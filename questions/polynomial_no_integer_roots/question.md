...
Let $p(x)$ be a polynomial with **integer coefficients**. Suppose $p(0)$ and $p(1)$ are both **odd**.

**Prove that $p(x)$ has no integer roots.**

---

*Hint: If $n$ is an integer root, consider whether $n$ is even or odd. In each case, try to relate $p(n)$ to either $p(0)$ or $p(1)$ using a factoring trick.*
